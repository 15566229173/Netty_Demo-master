...
class Person(object):
    ...
    def __init__(self, name=None, age=None, max=None,):
        self.name = name
        self.age = age
        self.max = max
    ...
    def write(self, oprot):
        ...
        if self.max is not None:
            oprot.writeFieldBegin('max', TType.BOOL, 3)
            oprot.writeBool(self.max)
            oprot.writeFieldEnd()
