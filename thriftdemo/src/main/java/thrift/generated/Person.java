...
public class Person implements org.apache.thrift.TBase<Person, Person._Fields>, java.io.Serializable, Cloneable, Comparable<Person> {
  ...
  private static final org.apache.thrift.protocol.TField MAX_FIELD_DESC = new org.apache.thrift.protocol.TField("max", org.apache.thrift.protocol.TType.BOOL, (short)3);
  ...
  private static final _Fields optionals[] = {_Fields.NAME,_Fields.AGE,_Fields.MAX};
  ...
  public Person setMax(boolean max) {
    this.max = max;
    setMaxIsSet(true);
    return this;
  }
  ...
  public int hashCode() {
    ...
    if (isSetMax())
      hashCode = hashCode * 8191 + ((max) ? 131071 : 524287);
